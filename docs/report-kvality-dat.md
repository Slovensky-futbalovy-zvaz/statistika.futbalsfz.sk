...
4. **VAR roly** (`Videorozhodca`, `Asistent videorozhodcu`, `Replay Operátor`) existujú len na `futbalsfz.sk`/`ulk.futbalnet.sk` a započítavajú sa medzi **rozhodcov**; `Hlavný usporiadateľ`, `Hlásateľ`, `Videotechnik`, `Pozorovateľ rozhodcov` tvoria skupinu **podporovatelia** (rozhodnutie 12. 7. 2026, viď roly.json).
